...
export class ExampleViewer implements OnInit {
  ...
  generateUrl(file: string): string {
    ...
    return this.exampleData
      ? `/roi-content/examples-highlighted/${this.exampleData.packagePath}/${fileName}`
      : '';
  }
  ...
  private _generateExampleTabs() {
    ...
    if (this.exampleData) {
      ...
      const docsContentPath = `/roi-content/examples-highlighted/${this.exampleData.packagePath}`;
