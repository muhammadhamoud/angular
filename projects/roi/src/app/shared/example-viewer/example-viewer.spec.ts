...
const exampleBasePath = `/roi-content/examples-highlighted/material/autocomplete/${exampleKey}`;
...
describe('ExampleViewer', () => {
  ...
  it('should return roi-content path for example based on extension', waitForAsync(() => {
    // set example
    component.example = exampleKey;
  ...
  describe('copy button', () => {
    ...
    beforeEach(() => {
      ...
      const btnDe = fixture.debugElement.query(By.css('.roi-example-source-copy'));
