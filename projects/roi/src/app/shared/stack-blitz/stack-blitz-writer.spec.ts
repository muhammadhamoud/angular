...
const testExampleBasePath = `/roi-content/examples-source/cdk/my-comp/${testExampleId}`;

const FAKE_DOCS: {[key: string]: string} = {
  /* eslint-disable @typescript-eslint/naming-convention */
  '/assets/stack-blitz/src/index.html': '<material-roi-example></material-roi-example>',
  '/assets/stack-blitz/src/main.ts':
      `import {MaterialDocsExample} from './material-roi-example';`,
