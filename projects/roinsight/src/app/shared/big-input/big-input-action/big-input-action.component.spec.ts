...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<ROI-big-input-action></ROI-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<ROI-big-input-action [disabled]="true"></ROI-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<ROI-big-input-action fontSet="fas" fontIcon="trash"></ROI-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<ROI-big-input-action label="delete"></ROI-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<ROI-big-input-action (action)="actionHandler()"></ROI-big-input-action>';
    fixture = createHostComponent(template);
