...
export const actionSettingsChangeNightMode = createAction(
  '[Settings] Change Night Mode',
  props<{ autoNightMode: boolean }>()
);
...
export const actionSettingsChangeDarkTheme = createAction(
  '[Settings] Change Dark Theme',
