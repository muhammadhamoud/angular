...
export const selectChangeDarkTheme = createSelector(
  selectSettings,
...
export const selectEffectiveTheme = createSelector(
  ...
  selectNightTheme,
  selectIsNightHour,
  selectChangeDarkTheme,
  (theme, nightTheme, isNightHour, isDarkTheme) =>
    (isDarkTheme || isNightHour ? nightTheme : theme).toLowerCase()
);
