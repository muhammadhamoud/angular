...
export interface QueryObject {
  queryObject: { size: number; query: { bool: { must: ({ bool: { should: never[]; }; match?: undefined; range?: undefined; } | { match: { category: string; }; bool?: undefined; range?: undefined; } | { range: { price: { gte: any; lte: any; }; }; bool?: undefined; match?: undefined; })[]; }; } | { constant_score: { filter: { terms: { category: any[]; }; }; }; }; }
}
...
export class DbAbstractionLayerService {
   ...
   */
  getProductsByIds(queryObj: QueryObject){
   ...
   * 
   */
  initializeBasketHistory(userId: string) {
   ...
   */
  getBasketHistoryById(id: string) {
   ...
   * @param newBasket 
   */
  setNewBasket(id: string | undefined, newBasket: never[]){
   ...
   * Will be realized in next versions
   */
  addProductToComparison(id: string, product: Product){
   ...
   * Will be realized in next versions
   */
  removeProductFromComparison(id: string, idInComparison: string){
   ...
   */
  requestData(esIndex: string, type: string, queryObj:QueryObject){
   ...
   */
  requestFullData(esIndex: string, type: string, queryObj: {
      query: { term: { _id: string; }; } | { bool: { must: ({ bool: { should: never[]; }; match?: undefined; range?: undefined; } | { match: { category: string; }; bool?: undefined; range?: undefined; } | { range: { price: { gte: any; lte: any; }; }; bool?: undefined; match?: undefined; })[]; }; } | { bool: { should: { match: { category: string; }; }; }; } | {
         ...
         * There are method with queryObject parameter. {@link ProductService} use them to work with products. Query object are generated in this service.
         */
        bool: { must: ({ bool: { should: never[]; }; range?: undefined; } | { range: { price: { gte: number; lte: number; }; }; bool?: undefined; })[]; };
      } | { term: { _id: any; }; } | { bool: { must: never[]; }; }; size?: any; from?: any; aggs?: { max_price: { max: { field: string; }; }; min_price: { min: { field: string; }; }; };
    }){
   ...
   */
  requestItemsTotal(esIndex: string, type: string, queryObj: QueryObject){
   ...
   */
  getAttributes(queryObj: QueryObject){
   ...
   * 
   */
  connectSessionFlowToDB(sessionFlow: any, deviceId: string, sessionId: string){
