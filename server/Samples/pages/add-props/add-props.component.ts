import { FormGroup } from './../../../../../angular/learning/angular/packages/forms/src/model/form_group';
...
export class AddPropsComponent implements OnInit {
  ...
  constructor(protected fb: FormBuilder, protected dal: DbAbstractionLayerService, protected productService: ProductService) {
